...
//    }
    ...
    public ApiResponse<RestaurantResponseDTO.ReviewPreViewListDTO> getReviewList(@ExistRestaurant @PathVariable(name = "restaurantId") Long restaurantId, @ValidPage @RequestParam(name = "page") Integer page){
        restaurantCommandService.getReviewList(restaurantId, page);
        return null;
    }
